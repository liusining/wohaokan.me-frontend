...
export function authorization(returnTo = "") {
  window.location = `https://mixin.one/oauth/authorize?client_id=faf9c343-677e-4f84-89cd-4c5688f22f7c&scope=PROFILE:READ&response_type=code&return_to=${returnTo}`;
}
